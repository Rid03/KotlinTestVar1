package com.company.testvar1.test_support

import com.company.testvar1.TestVar1Application
...
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = ["com.company.testvar1.screen"])
@ContextConfiguration(classes = [TestVar1Application::class, UiTestAssistConfiguration::class])
